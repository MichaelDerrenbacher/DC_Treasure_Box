...
void main(void)
  {
    ...
    */
    ...
    while(1)
    {
        ...
        {
            value = (5.7 * DAC_MAX) / (GAIN * DAC_REF);
            ...
            while(!finish)
           {
               ...
               for(j = 0; j<2; j++)
               {
                   ...
                   meas1 = meas * 1.0017629 + 0.0382527;    // 0x00 scaling
               ...
               for(j = 0; j<2; j++)
               {
                   ...
                   meas2 = meas * 1.0038643 - 0.0163124;    // 0x01 scaling
               }
